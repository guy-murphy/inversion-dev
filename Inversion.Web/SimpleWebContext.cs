...
namespace Inversion.Web {
	...
	public class SimpleWebContext : ProcessContext, IWebContext {
		...
		public SimpleWebContext(HttpContext underlyingContext, IServiceContainer services, IResourceAdapter resources)
