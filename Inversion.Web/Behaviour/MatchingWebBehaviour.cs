...
namespace Inversion.Web.Behaviour {
	...
	public abstract class MatchingWebBehaviour: MatchingBehaviour, IWebBehaviour, IConfiguredBehaviour {
		...
		protected MatchingWebBehaviour(string respondsTo, BehaviourConfiguration config) : base(respondsTo, config) { }
		...
		/// <param name="respondsTo">The message the behaviour will respond to.</param>
		/// <param name="config">Configuration for the behaviour.</param>
		protected MatchingWebBehaviour(string respondsTo, IEnumerable<BehaviourConfiguration.Element> config) : base(respondsTo, config) { }
